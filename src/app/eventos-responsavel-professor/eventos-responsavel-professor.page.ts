...
@Component({
  selector: 'app-eventos-responsavel-professor',
  templateUrl: './eventos-responsavel-professor.page.html',
  styleUrls: ['./eventos-responsavel-professor.page.scss'],
})
export class EventosResponsavelProfessorPage implements OnInit {
